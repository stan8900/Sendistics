...
- **Для администраторов**: «⚒ Авторассылка» (кнопка видна всем пользователям, чтобы каждый мог запустить общую рассылку), «📊 Статистика», «📋 Выбрать группы», «⚙️ Настройки», «📜 Оплаты».
...
6. Нажмите «▶️ Запустить», чтобы включить рассылку. Бот отправит сообщение во все выбранные чаты и будет повторять отправку по расписанию; запускать авторассылку могут все пользователи, у которых есть доступ к боту.
